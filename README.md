...
5. **Administrador del sistema**: Gestiona usuarios, supervisa el sistema y garantiza su correcto funcionamiento  
...
- [ ] Sistema de control parental para supervisión y gestión de cuentas de menores  
...
**¿Por qué?**: Permite trabajar de forma iterativa, entregando avances constantes y adaptándose a cambios durante el desarrollo del proyecto.
...
**¿Por qué?**: Permite separar responsabilidades entre presentación, lógica de negocio y datos, facilitando el mantenimiento, la escalabilidad y la organización del sistema.

---

### Tecnologías

- **Backend**: FastAPI (permite manejar lógica compleja y validaciones de forma clara y estructurada)  
- **Base de datos**: PostgreSQL (robusto, gratuito y confiable)  
- **Frontend**: React (flexible y con gran comunidad)  
...
*Documento en constante evolución según el desarrollo del proyecto.*# MoneBank
